...
export default class Search extends Component {
  ...
  sendSearch = (id) => {
    console.log(id);
    const endPoint =
      "http://2tor-pruebas.eba-39fqbkdu.us-west-1.elasticbeanstalk.com/auth/save-search/";
    let collection = {};
        ...
        <View style={styles.container}>
          <View style={styles.searchContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => this.getData(this.state.valueSearch)}
            >
            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                ...
                <Text style={styles.modalText}>
                  {this.state.modalData.name_lastname}
                </Text>
                <TouchableHighlight
